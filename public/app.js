// User map: load banner, draw kelurahan boundaries (outline only), color points by kelurahan
(function(){
  ...
  function buildLegendFromList(list){
    ...
    legend.onAdd = function() {
      ...
      div.innerHTML = '<h4 style="margin:0 0 10px 0; font-size:0.95rem; font-weight:700;">📍 Legenda Kelurahan</h4>';
      kelurahList.forEach(k => {
        const key = String(k.name||'').trim().toLowerCase();
